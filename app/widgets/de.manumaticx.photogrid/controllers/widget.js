...
function addItem(item, _index, _thumbSize){
    ...
    var itemView;
    //if(item.record.post_type =="image" || item.record.user_post_type =="image"){
    	itemView = (
    ...
    // }else{
    	// var mediaURL = item.record.user_post_data;
    	// if(mediaURL == undefined)
    		// mediaURL = item.record.post_data;
    	// itemView = Ti.Media.createVideoPlayer({
    		// url: mediaURL,
    		// autoplay : false
    		// });
// 	    
